...
import toolz  #1 (line in Coconut source)
from lib.helpers import prepare  #2 (line in Coconut source)
import numpy as np  #3 (line in Coconut source)
from statsmodels.stats.stattools import medcouple  #4 (line in Coconut source)

# data |> toolz.partition$(3) |> list |> print

(print)((prepare)((np.sort)(np.random.rand(3000))))  #8 (line in Coconut source)
